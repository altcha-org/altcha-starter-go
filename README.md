# ALTCHA Server Demo for Go

> [!WARNING]
> DEPRECATED: This repository is no longer maintained. Please refer to [`altcha-lib-go`](https://github.com/altcha-org/altcha-lib-go) for the current implementation and examples.
